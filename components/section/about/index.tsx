  ...
  const skillsData = [
    {
      ...
      icons: [
        ...
        { key: "css3", text: "CSS", icon: <SiCss3 size={16} className="text-gray-800 dark:text-gray-100"/> },
        ...
        { key: "markdown", text: "Markdown", icon: <SiMarkdown size={16} className="text-gray-800 dark:text-gray-100"/> },
        { key: "python", text: "Python", icon: <SiPython size={16} className="text-gray-800 dark:text-gray-100"/> },
        { key: "sql", text: "SQL", icon: <SiMysql size={16} className="text-gray-800 dark:text-gray-100"/> },
    ...
    },
    {
      ...
      icons: [
        ...
        { key: "bootstrap", text: "Bootstrap", icon: <SiBootstrap size={16} className="text-gray-800 dark:text-gray-100"/> },
        { key: "electron", text: "Electron", icon: <SiElectron size={16} className="text-gray-800 dark:text-gray-100"/> },
        { key: "express", text: "Express", icon: <SiExpress size={16} className="text-gray-800 dark:text-gray-100"/> },
        ...
        { key: "socketio", text: "Socket.IO", icon: <SiSocketdotio size={16} className="text-gray-800 dark:text-gray-100"/> },
        { key: "tailwindcss", text: "Tailwind CSS", icon: <SiTailwindcss size={16} className="text-gray-800 dark:text-gray-100"/>},
        { key: "tauri", text: "Tauri", icon: <SiTauri size={16} className="text-gray-800 dark:text-gray-100"/> },
        { key: "vite", text: "Vite", icon: <SiVite size={16} className="text-gray-800 dark:text-gray-100"/> },
      ],
    },
    {
      title: t("tools"),

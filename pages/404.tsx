...
const NotFound: NextPage = (): ReactElement => {
  ...
  return (
    ...
    <div className='not_found cursor-crosshair'>
      ...
      <p className="flex justify-center text-black-900 dark:text-white">Don't worry here are some of my favorite rock songs</p>
      <br />
  ...
  <tbody>
    <tr>
      <td>CHOKE feat. grandson & Zero 9:36</td>
      <td>The Warning</td>
      <td>2022</td>
    </tr>
    <tr>

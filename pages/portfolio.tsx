    ...
    <div className='portfolio'>
      ...
      <br />
        <div className='flex items-center justify-center p-2 leading-tight md:p-4'>
          <div className='flex items-center justify-center'>
            <article className="overflow-hidden border-2 rounded-lg shadow-lg dark:hover:border-violet-800 hover:border-yellow-500 grayscale hover:grayscale-0">
                <a href="https://github.com/Rawierdt/Tidex" target={'_blank'}><img className="block w-full h-auto" draggable="false" loading="lazy" src="https://i.ibb.co/y6VgstT/tidex.gif" width="800" height="400" alt='Tidex' title='Tidex Ransomware'></img></a>
            </article>
            </div>
            <div className='flex items-center justify-center'>
              <article className="overflow-hidden border-2 rounded-lg shadow-lg dark:hover:border-violet-800 hover:border-yellow-500 grayscale hover:grayscale-0">
              <a href="https://github.com/Rawierdt/Metacrawler-IPTracker" target={'_blank'}><img className="block w-full h-auto" draggable="false" loading="lazy" src="https://i.ibb.co/FKnL9r1/M-iptrack.gif" width="800" height="400" alt='Rawier' title='Metacrawler & IPTracker'></img></a>
              </article>
            </div>
            <div className='flex items-center justify-center'>
              <article className="overflow-hidden border-2 rounded-lg shadow-lg dark:hover:border-violet-800 hover:border-yellow-500 grayscale hover:grayscale-0">
              <a href="https://github.com/Rawierdt" target={'_blank'}><img className="block w-full h-auto" draggable="false" loading="lazy" src="https://i.ibb.co/f16Mt2R/rawierID.gif" width="800" height="400" alt='Rawier' title='Rawier'></img></a>
              </article>
            </div>            
        </div>
        {/* 𝕽♛ */}

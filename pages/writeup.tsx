...
import { SiCisco, SiHackthebox, SiTryhackme, SiRootme } from "react-icons/si";
    ...
    <>
      ...
      <div className='portfolio'>
        ...
        <p className="flex justify-center font-semibold text-center">
          Troubleshooting machine hacking in lab environments, mainly using Try Hack Me, Hack The Box, VulnHub, etc.
        </p>
        <br />

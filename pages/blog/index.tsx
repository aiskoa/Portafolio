  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Blog section - Here I have all the blog posts I had written in the past" />
        <meta property="og:description" content="Blog section - Here I have all the blog posts I had written in the past" />
      ...
      <div className="container px-4 mx-auto my-12 md:px-12">
        ...
        {/* Renderizado de publicaciones en una cuadrícula */}
...
// Obtiene los datos de las publicaciones en tiempo de construcción
